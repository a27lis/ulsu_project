  ...
  <body>
    ...
    <div class="grammar-b">
      <div class="topic-info">
        <div class="topic-el">
          <a href="lesson1.php" class="menu-item">
            Урок грамматики 1. Present continuous
          </a>
        </div>
        <div class="topic-el">
          <a href="lesson2.php" class="menu-item"
            >Урок грамматики 2. Present simple (I do)
          </a>
        </div>
        <div class="topic-el">
          <a href="lesson3.php" class="menu-item">
            Урок грамматики 3. Present continuous and present simple 1 (I am
            doing and I do)
          </a>
        </div>
      </div>
